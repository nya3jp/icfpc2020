...
# Derived from https://github.com/tensorflow/tensorflow/blob/master/third_party/curl.BUILD
# Changes:
# - Replaced condition references to @org_tensorflow with @bazel_tools
# - Dropped Android/iOS support
# - Dropped SSL dependency
...
cc_library(
    ...
    srcs = [
        ...
        "@bazel_tools//src/conditions:windows": CURL_WIN_SRCS,
        "//conditions:default": [],
    }),
    hdrs = [
        "include/curl/curl.h",
    ...
    copts = select({
        "@bazel_tools//src/conditions:windows": CURL_WIN_COPTS,
        "//conditions:default": [
            "-Iexternal/curl/lib",
            "-D_GNU_SOURCE",
            "-DBUILDING_LIBCURL",
...
cc_binary(
    ...
    copts = select({
        "@bazel_tools//src/conditions:windows": CURL_BIN_WIN_COPTS,
        "//conditions:default": [
            "-Iexternal/curl/lib",
            "-D_GNU_SOURCE",
            "-DHAVE_CONFIG_H",
